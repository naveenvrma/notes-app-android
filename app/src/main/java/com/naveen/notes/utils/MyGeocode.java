...
public class MyGeocode {
    public static List<Address> getFromLocation(double lat, double lng, int maxResult) {
        ...
        try {
            ...
            Log.e(MyGeocode.class.getName(), "Error calling Google geocode webservice.", e);
        } catch (IOException e) {
            Log.e(MyGeocode.class.getName(), "Error calling Google geocode webservice.", e);
        } catch (JSONException e) {
            Log.e(MyGeocode.class.getName(), "Error parsing Google geocode webservice response.", e);
        }

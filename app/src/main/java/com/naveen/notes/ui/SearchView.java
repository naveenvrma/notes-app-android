...
public class SearchView extends FrameLayout {
    ...
    private void initViewAttribute(Context context, AttributeSet attributeSet, int defStyleAttr) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet,
                R.styleable.SearchView, defStyleAttr, 0);
        if (attr != null) {
            try {

                if (attr.hasValue(R.styleable.SearchView_searchLiveoHint)) {
                    hint(attr.getString(R.styleable.SearchView_searchLiveoHint));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoTextColor)) {
                    mEdtSearch.setTextColor(attr.getColor(
                            R.styleable.SearchView_searchLiveoTextColor, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoHintColor)) {
                    mEdtSearch.setHintTextColor(attr.getColor(
                            R.styleable.SearchView_searchLiveoHintColor, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoColorIcon)) {
                    setColorIcon(attr.getColor(
                            R.styleable.SearchView_searchLiveoColorIcon, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoColorArrow)) {
                    setColorIconArrow(attr.getColor(
                            R.styleable.SearchView_searchLiveoColorArrow, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoColorVoice)) {
                    setColorIconVoice(attr.getColor(
                            R.styleable.SearchView_searchLiveoColorVoice, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoColorClose)) {
                    setColorIconClose(attr.getColor(
                            R.styleable.SearchView_searchLiveoColorClose, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoBackground)) {
                    mViewSearch.setBackgroundColor(attr.getColor(
                            R.styleable.SearchView_searchLiveoBackground, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoStatusBarShowColor)) {
                    setStatusBarShowColor(attr.getColor(
                            R.styleable.SearchView_searchLiveoStatusBarShowColor, -1));
                }

                if (attr.hasValue(R.styleable.SearchView_searchLiveoStatusBarHideColor)) {
                    setStatusBarHideColor(attr.getColor(
                            R.styleable.SearchView_searchLiveoStatusBarHideColor, -1));
                }
            } finally {
                attr.recycle();
            }
     ...
     */
    public SearchView with(Context context) {
     ...
     */
    public SearchView with(Activity getActivity, OnSearchListener context) {
     ...
     */
    public SearchView hideSearch(OnHideSearchListener onHideSearchListener) {
     ...
     *
     */
    public SearchView hideKeyboardAfterSearch() {
     ...
     */
    public SearchView searchDelay(int delay) {
     ...
     *
     */
    public SearchView removeSearchDelay() {
        this.mSearchDelay = 0;
        return this;
    }
     ...
     */
    public SearchView minToSearch(int minToSearch) {
        this.mMinToSearch = minToSearch;
        return this;
    }

    public SearchView removeMinToSearch() {
        this.mMinToSearch = 0;
        return this;
    }
     ...
     */
    public SearchView backgroundResource(int resId) {
     ...
     */
    public SearchView backgroundColor(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView hintColor(int color) {
     ...
     * @param text "valeu"
     */
    public SearchView text(String text) {
     ...
     */
    public SearchView text(int text) {
     ...
     * @param text "valeu"
     */
    public SearchView hint(String text) {
     ...
     * @param text string attribute - string.xml file
     */
    public SearchView hint(int text) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView colorIcon(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView colorIconArrow(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView colorIconVoice(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView colorIconClose(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView statusBarHideColor(int color) {
     ...
     * @param color color attribute - colors.xml file
     */
    public SearchView statusBarShowColor(int color) {
     ...
     *
     */
    public SearchView imeActionSearch(){
    ...
    public void resultVoice(int requestCode, int resultCode, Intent data) {
        if (requestCode == SearchView.REQUEST_CODE_SPEECH_INPUT) {
